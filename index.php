...
<body>
    ...
    <div class="bg-red-700 mx-auto text-center py-2">
        <h1 class="text-xl text-white font-bold mx-4 sm:mx-0">
            Seniors On Medicare Can Get Hundreds In Savings. <b>Tap Below To Qualify!</b>
        </h1>
    </div>
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        ...
        <p class="my-3 md:text-xl" style="text-align: left;">
            Many elderly Americans are quickly updating their 2024 Medicare plans to obtain a $2,500 spending card. This card allows them to <b>purchase goods at numerous stores</b> nationwide.
        </p>
        <p class="my-3 md:text-xl" style="text-align: left;">
            Unfortunately, a large number of seniors might lose the opportunity to secure this card as the registration period is drawing to a close. Ensure you're eligible by responding to two questions below <b>before it's too late.</b>
        </p>
        <div>
    ...
    <div id="display3" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container ">
        <h3 class="font-bold text-center md:text-4xl text-3xl my-8">
    ...
    <script>
        ...
        btn3.addEventListener("click", () => {
            ...
            const newUrl = new URL(window.location.href);
            newUrl.searchParams.set('age', '63');
            window.history.pushState({
                path: newUrl.href
            }, '', newUrl.href);
